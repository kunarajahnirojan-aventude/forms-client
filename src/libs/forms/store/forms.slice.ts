...
const SEED_FORMS: Form[] = [
  {
    ...
    status: 'published',
    pages: [
      { id: nanoid(), title: 'General Information', questions: [] },
      { id: nanoid(), title: 'Work Environment', questions: [] },
      { id: nanoid(), title: 'Team & Management', questions: [] },
    ],
  ...
  },
  {
    ...
    status: 'published',
    pages: [
      { id: nanoid(), title: 'Product Experience', questions: [] },
      { id: nanoid(), title: 'Feature Requests', questions: [] },
    ],
  ...
  },
  {
    ...
    status: 'closed',
    pages: [
      { id: nanoid(), title: 'Personal Details', questions: [] },
      { id: nanoid(), title: 'Session Preferences', questions: [] },
      { id: nanoid(), title: 'Dietary & Accessibility', questions: [] },
    ],
  ...
  },
  {
    ...
    status: 'draft',
    pages: [
      { id: nanoid(), title: 'Personal Information', questions: [] },
      { id: nanoid(), title: 'Role & Department', questions: [] },
    ],
    settings: defaultSettings(),
